...
PAGE_KEY = "antibacterial"
CATEGORY = "Antibacterial"

GRAPH_CONFIG = {
    "displaylogo": False,
    "toImageButtonOptions": {"format":"png","filename":"dairybio_antibacterial","height":800,"width":1600,"scale":3},
...
def register_callbacks(app):
    ...
    def update_module(features, mode, status, view, fname):
        allowed = (mode == "full") or (mode == "antibacterial")
        if not allowed:
