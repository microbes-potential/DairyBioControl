        ...
        html.Div([
            html.Div(
                ...
                style={
                    "height": "10px",
                    "width": "0%",
                    "background": "linear-gradient(90deg,#7ad,#4bb)",
...
def page_upload():
    return html.Div([
        ...
        # NOTE: Stores are global in app layout. Do NOT redeclare them here.
        ...
        html.Div([
            ...
            dcc.RadioItems(
                ...
                value="full",
                options=[
                    {"label": "🔍 Full Analysis (All Modules)", "value": "full"},
        ...
        html.Div(
            ...
            style={"marginTop": "10px", "color": "#556", "fontStyle": "italic", "fontSize": "15px"}
        ),
    ], style={"padding": "16px 18px"})

def register_callbacks(app):
    @app.callback(
        Output("store-upload-started", "data"),
